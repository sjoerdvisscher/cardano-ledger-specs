...
{-
The plutusScript below is a compiled (and then converted to [Word8]).
...
unpackedGuessTheNumber3 :: [Word8]
unpackedGuessTheNumber3 =
  [ 1,
    0,
    0,
    50,
...
guessTheNumber3 :: ShortByteString
guessTheNumber3 = pack unpackedGuessTheNumber3
